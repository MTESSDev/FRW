...
| libellesFormulaire | objet | `Disponible à partir de la version 2023.6`Tous les libellés associés à des champs du formulaire dans toutes les langues disponibles<details><summary>**libellesFormulaire**</summary>**label** : Le libellé de la question<br> **options** : Le libellé des choix pour les questions à choix multiples<br> **components** : S'applique pour un groupe dans un groupe</details>|
